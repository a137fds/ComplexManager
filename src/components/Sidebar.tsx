...
export const Sidebar: React.FC<SidebarProps> = ({ currentTab, onTabSelect, currentRole, currentLang }) => {
  ...
  const labels = {
    ...
    tr: { complex: 'Kompleks (Site)', database: 'Cloud SQL (CRUD)', settings: 'Yönetim', role: 'Rol Yetkileri', roleDesc: 'Yetkiler yönetici tarafından Yönetim bölümünde merkezi olarak yönetilir.', law: '634 Sayılı Kat Mülkiyeti Kanunu', governance: 'Kompleks Yönetimi ve Denetim Standardı' },
    ...
    da: { complex: 'Kompleks (Site)', database: 'Cloud SQL (CRUD)', settings: 'Administration', role: 'Rollebaserede rettigheder', roleDesc: 'Rettigheder administreres centralt af en administrator under Administration.', law: 'Lov nr. 634 om ejerlejligheder i Tyrkiet', governance: 'Kompleksstyring og revision' },
    sv: { complex: 'Komplex (Site)', database: 'Cloud SQL (CRUD)', settings: 'Administration', role: 'Rollbehörigheter', roleDesc: 'Behörigheter hanteras centralt av en administratör under Administration.', law: 'Turkiets lag nr 634 om ägarlägenheter', governance: 'Komplexstyrning och revision' },
