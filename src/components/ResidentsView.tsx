...
export const ResidentsView: React.FC<ResidentsViewProps> = ({ currentLang, currentRole }) => {
  ...
  if (loading) return <div className="min-h-[240px] flex items-center justify-center text-slate-500"><Loader2 className="w-7 h-7 animate-spin" aria-label="Loading apartments" /></div>;
